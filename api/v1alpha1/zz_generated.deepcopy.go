...
func (in *Be) DeepCopyInto(out *Be) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Be.
func (in *Be) DeepCopy() *Be {
	if in == nil {
		return nil
	}
	out := new(Be)
...
func (in *Be) DeepCopyObject() runtime.Object {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BeList) DeepCopyInto(out *BeList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BeList.
func (in *BeList) DeepCopy() *BeList {
	if in == nil {
		return nil
	}
	out := new(BeList)
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *BeList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Beconfig) DeepCopyInto(out *Beconfig) {
	*out = *in
	if in.Replicas != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Beconfig.
func (in *Beconfig) DeepCopy() *Beconfig {
	if in == nil {
		return nil
	}
	out := new(Beconfig)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Fe) DeepCopyInto(out *Fe) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Fe.
func (in *Fe) DeepCopy() *Fe {
	if in == nil {
		return nil
	}
	out := new(Fe)
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *Fe) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FeList) DeepCopyInto(out *FeList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FeList.
func (in *FeList) DeepCopy() *FeList {
	if in == nil {
		return nil
	}
	out := new(FeList)
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *FeList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Feconfig) DeepCopyInto(out *Feconfig) {
	*out = *in
	if in.Replicas != nil {
		in, out := &in.Replicas, &out.Replicas
		*out = new(int32)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Feconfig.
func (in *Feconfig) DeepCopy() *Feconfig {
	if in == nil {
		return nil
	}
	out := new(Feconfig)
