...
//+kubebuilder:rbac:groups=operator.doris.io,resources=brokers,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=operator.doris.io,resources=brokers/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=operator.doris.io,resources=brokers/finalizers,verbs=update
